...
import DomainContactsForm from '../../features/account/DomainContactsForm';
    ...
    <>
      ...
      <Container style={{ padding: '7em 0 4em 0' }} >
        <Routes>
          ...
          <Route path='profiles/:domain/:contactsType' element={userStore.isLoggedIn ? <DomainContactsForm /> : <SignUpSignInForm />} />
        </Routes>
      </Container>
    </>
  );
